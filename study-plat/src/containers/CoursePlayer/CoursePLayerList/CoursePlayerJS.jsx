...
import { javascriptCourse } from '../../../data/CoursePlayers'
import ThemeToggle from '../../../components/ThemeToggle/ThemeToggle'

const CoursePlayerJS = () => {
    ...
    return (
        ...
        <h3 className="heading">JavaScript course</h3>
